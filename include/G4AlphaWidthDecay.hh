...
#ifndef G4AlphaWidthDecay_h
#define G4AlphaWidthDecay_h 1

#include "G4NuclearDecay.hh"


class G4AlphaWidthDecay : public G4NuclearDecay
{
public:
    G4AlphaWidthDecay(const G4ParticleDefinition* theParentNucleus,
                        const G4double& theBR, const G4double& Qvalue,
                        const G4double& excitation, const G4Ions::G4FloatLevelBase& flb);

    virtual ~G4AlphaWidthDecay();
